            ...
            <div class="contact__container">
                ...
                <form action="" method="">
                    <div class="contact__col">
                        ...
                        <div>
                            <div>
                                <input type="tel" class="contact__tel group__input" required="required" name=""
                                    id="yourtel" placeholder="Số điện thoại*" tabindex="1" autocomplete="off">
                            </div>
                    ...
                    <div>
                        <div>
                            <input type="text" class="contact__question group__input" required="required" name=""
                                id="yourquestion" placeholder="Nhập câu hỏi của bạn*" tabindex="1"
                                autocomplete="off">
                        </div>
