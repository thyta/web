    ...
    <header class="header__pc" style="z-index: 9999;">
                ...
                <ul class="group__product--list" id="new-product-list">
                    ...
                    <li class="group__product--item">
                        <a href="" class="group__product--link link-pc">
                            ...
                            <img src="../img/nuocduongtoc14ml.png" alt="">
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="group__third--sidebar side-bar-third" id="third-sidebar">
            ...
            <div class="group__third--content group__background" id="skincare-1">
                <img src="../img/backgroundda.png" alt="">
            </div>
            <!-- CHONG NANG -->
                ...
                <ul class="group__product--list" id="skincare-2-list">
                    <li class="group__product--item">
                        <a href="" class="group__product--link link-pc">
                            ...
                            <img src="../img/suachongnang50ml.png" alt="">
                        </a>
                    </li>
                    ...
                    <li class="group__product--item">
                        <a href="" class="group__product--link link-pc">
                            ...
                            <img src="../img/suachongnang15ml.png" alt="">
                        </a>
                    </li>
                    ...
                    <li class="group__product--item">
                        <a href="" class="group__product--link link-pc">
                            ...
                            <img src="../img/kemchongnang50ml.png" alt="">
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <ul class="group__product--list" id="skincare-3-list">
                    ...
                    <li class="group__product--item">
                        <a href="" class="group__product--link link-pc">
                            ...
                            <img src="../img/nuoctaytrang310ml.png" alt="">
                        </a>
                    </li>
                    ...
                    <li class="group__product--item">
                        <a href="" class="group__product--link link-pc">
                            ...
                            <img src="../img/dautaytrang140ml.png" alt="">
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <ul class="group__product--list" id="skincare-4-list">
                    <li class="group__product--item">
                        <a href="" class="group__product--link link-pc">
                            ...
                            <img src="../img/gelruamat140ml.png" alt="">
                        </a>
                    </li>
                    ...
                    <li class="group__product--item">
                        <a href="" class="group__product--link link-pc">
                            ...
                            <img src="../img/suaruamatHungYen140ml.png" alt="">
                        </a>
                    </li>
                    ...
                    <li class="group__product--item">
                        <a href="" class="group__product--link link-pc">
                            ...
                            <img src="../img/gelruamathoahong140ml.png" alt="">
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <ul class="group__product--list" id="skincare-5-list">
                    <li class="group__product--item">
                        <a href="" class="group__product--link link-pc">
                            ...
                            <img src="../img/taydachetcapheDakLak150ml.png" alt="">
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <ul class="group__product--list" id="skincare-6-list">
                    <li class="group__product--item">
                        <a href="" class="group__product--link link-pc">
                            ...
                            <img src="../img/matnabidao30ml.png" alt="">
                        </a>
                    </li>
                    ...
                    <li class="group__product--item">
                        <a href="" class="group__product--link link-pc">
                            ...
                            <img src="../img/matnahoahong100ml.png" alt="">
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="group__third--content" id="haircare-1">
                <img src="../img/bachkgroundtoc.png" alt="">
            </div>
            <!-- DAU GOI -->
                ...
                <ul class="group__product--list" id="haircare-2-list">
                    <li class="group__product--item">
                        <a href="" class="group__product--link link-pc">
                            ...
                            <img src="../img/daugoibuoi310ml.png" alt="">
                        </a>
                    </li>
                    ...
                    <li class="group__product--item">
                        <a href="" class="group__product--link link-pc">
                            ...
                            <img src="../img/daugoibuoi500ml.png" alt="">
                        </a>
                    </li>
                    ...
                    <li class="group__product--item">
                        <a href="" class="group__product--link link-pc">
                            ...
                            <img src="../img/daugoibuoirefill500ml.png" alt="">
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <!-- <div class="contact side-bar-center" id="contact">
            <div>
                ...
                <div>Liên hệ với Cosmetic</div>
                <form action="">
                    <div>
                        <div>
                            <input type="text" required="required" name="" id="yourname" placeholder="Tên của bạn*">
                        </div>
                        <div>
                            <input type="tel" required="required" name="" id="yourtel" placeholder="Số điện thoại*">
                        </div>
                    </div>
                    <div>
                        <input type="email" required="required" name="" id="" placeholder="Địa chỉ Email*">
                    </div>
                    <div>
                        <input type="text" required="required" name="" id="" placeholder="Nhập câu hỏi của bạn*">
                    </div>
                    <div>
                        <button>GỬI COSMETIC</button>
                        <a href="">GỌI CHO COSMETIC</a>
                    </div>
                </form>
            </div>
        </div> -->
